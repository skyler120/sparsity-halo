...
parser = argparse.ArgumentParser(description='PyTorch CIFAR10/100 Pruning')
# Datasets
...
def main():
    ...
    # print(total, total_nonzero, args.percent)
    thre = y[int(thre_index)]
    pruned = 0
    print('Pruning threshold: {}'.format(thre))
    np.save(os.path.join(args.save_dir, 'prune_threshold'), [thre])
    zero_flag = False
...
def save_checkpoint(state, is_best, checkpoint, filename='pruned_{}.pth.tar'.format(args.percent)):
